...
--------------------------------------------------
Gemini artık doğrudan kod yazmayacaktır. ASLA KOD YAZILMAYACAK.
...
Kod implementasyonu:
KESİNLİKLE VE SADECE Claude tarafından yapılacaktır. Gemini tarafından bir satır bile kod üretilmeyecektir.

--------------------------------------------------
# ZORUNLU KURALLAR (MANDATORY RULES)
--------------------------------------------------

1. Gemini HER ZAMAN önce analiz yapacak. ASLA kod yazmayacak, implementasyon üretmeyecek, toplu kod dump’ı çıkarmayacak. Önce: risk analizi, etkilenen dosyalar, lifecycle etkileri, memory/performance etkileri ve regression riskleri çıkarılacak.
