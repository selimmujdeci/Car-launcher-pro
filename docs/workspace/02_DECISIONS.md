...
- Kanıt/otorite: `docs/workspace/00_START_HERE.md` §A · `docs/archive/project/PROJECT_MEMORY.md` başlığı
...
- Tarih: 2026-07-27 (kayıt; kural 2026-07-15'ten beri yürürlükte)
- Durum: ACTIVE
...
- Kanıt/otorite: `CLAUDE.md` (tek global çalışma kuralı; otomatik ajan yönlendirme yoktur)
- İlgili dosyalar: `CLAUDE.md`
...
- Gerekçe: Dört ayrı "önce şunu oku" talimatı (`CONTRIBUTING.md §0`, `HANDOFF.md §1`,
  `CLAUDE.md`, `docs/archive/project/MASTER_PROMPT.md`) birbirini tutmuyordu.
...
- İlgili dosyalar: `CONTRIBUTING.md`, `docs/archive/HANDOFF.md`, `docs/archive/project/MASTER_PROMPT.md`
...
- Sonuç/sınır: Somut hata örneği — `docs/archive/project/DEVICE_VALIDATION.md` kütük içeriğini
...
## DEC-006 — Saha doğrulamasında mutlak otorite `docs/DEVICE_VALIDATION_LEDGER.md`'dir
...
- Kanıt/otorite: `docs/DEVICE_VALIDATION_LEDGER.md` başlığı · `docs/archive/AI.md` → REAL DEVICE REQUIRED · `CLAUDE.md`
...
- Tarih: 2026-07-27 (kayıt; `docs/archive/project/PROJECT_MEMORY.md`'de kayıtlı)
- Durum: ACTIVE
...
- Kanıt/otorite: `docs/archive/project/PROJECT_MEMORY.md` → "Neden Zero-Trust Telemetry" · `CLAUDE.md`
...
- Kanıt/otorite: `docs/archive/project/PROJECT_MEMORY.md` → "Neden Fail-Closed Ignition"
...
- Tarih: 2026-07-27 (kayıt; `docs/archive/AI.md` MODE bölümünde yürürlükte)
- Durum: ACTIVE
...
- Kanıt/otorite: `docs/archive/AI.md` → MODE · `CLAUDE.md` · `docs/adr/0002-low-end-head-unit-performance-mode.md`
...
- Kanıt/otorite: `CLAUDE.md` → FAZ A · `docs/archive/CAROS_LAB_DEVELOPER_PLATFORM_STRATEGY.md`
...
- Kanıt/otorite: `src/platform/maviCore/wiring/takeoverPolicy.ts:22` · `docs/archive/MAVI_NEXT_VISION.md`
...
- Kanıt/otorite: `docs/archive/project/PROJECT_MEMORY.md` → "Neden SAB/COI prod'da KAPALI"
...
- Kanıt/otorite: `CLAUDE.md` → TİCARİ LİSANS bölümü · `docs/archive/project/PROJECT_MEMORY.md` → "Neden BYOK"
