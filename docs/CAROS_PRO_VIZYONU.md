...
> `docs/archive/NAVIGATION_MINI_MAP_SESSION_CONTINUITY_P0_REPORT.md`)
> **Önceki iş:** NAV-CORE-P0 — navigasyon çekirdeği güvenilirliği (§6.3, kütük #364–#372,
> `docs/archive/NAVIGATION_CORE_RELIABILITY_P0_REPORT.md`)
...
| Belge | Rolü | Otorite |
|---|---|---|
| `CLAUDE.md` | Anayasa — çalışma kuralları | **Mutlak** (çatışmada `docs/archive/AI.md` ile birlikte kazanır) |
| `docs/archive/AI.md` | Uygulama kuralları (atomik patch, real-device) | **Mutlak** |
...
| `docs/architecture/CAROS_VEHICLE_INTELLIGENCE_ARCHITECTURE.md` | Mimari referans (katmanlar, motorlar, invaryantlar) | Mimari "nasıl" sorusunda birincil |
| `docs/archive/MAVI_NEXT_VISION.md` | **Mavi (sesli AI) uzun vadeli ürün vizyonu** (8 modül, Yol Arkadaşı, voice-first) | Mavi vizyon/yönünde birincil; durum bu belgede DEĞİL |
| `docs/mavi/CAROS_MAVI_ULTIMATE_OEM_ARCHITECTURE_SPEC_v1.md` | **Mavi hedef MİMARİSİ (OEM++)** — repo denetimi (ölçülmüş) · KEEP listesi · Capability Fabric · streaming konuşma · gecikme bütçesi · F0–F13 fazları · ADR'ler | Mavi **mimari "nasıl"** sorusunda birincil; **saha durumu bu belgede DEĞİL** (kütük mutlak) |
| `docs/mavi/MAVI_FLAG_EXIT_CRITERIA.md` | **16 Mavi feature flag'inin exit criteria'sı** — açılma ölçütü · `default ON` şartı · kaldırma şartı · rollback sözleşmesi · ≤2 hedefine giden migration planı | Bayrak açma/kapama/kaldırma kararında **birincil**; saha durumu bu belgede DEĞİL (kütük mutlak) |
| `docs/archive/OBD_DIAGNOSTIC_OS_ROADMAP.md` | OBD/teşhis **alt-roadmap'i** (FAZ 0–4 görev kırılımı) | OBD görev detayında birincil |
| `docs-local/caros-feature-audit.html` | 57 özellik **detay denetim görünümü** | Denetim ayrıntısında yardımcı |
| `docs/archive/CAROS_15_YIL_VIZYON_YOL_HARITASI.md` | 2026-07-08 tarihli denetim fotoğrafı | **Tarihsel** — bayat, güncellenmiyor |
| `docs/archive/ROADMAP.md` (kök) | 2026-06-24 tarihli yol haritası | **Tarihsel** — bayat, güncellenmiyor |
...
- **MAVI-F13/2 · `voiceService` AYRIŞTIRMASI + BAYRAK EXIT CRITERIA
  ...
  **8) BAYRAK EXIT CRITERIA YAZILDI — `docs/mavi/MAVI_FLAG_EXIT_CRITERIA.md`.**
  ...
  **AÇIK BORÇLAR (dürüstçe):**
  1. **F13 KAPANMADI.** Spec §29 kabul ölçütleri karşılanmadı: `voiceService`
     **3139 satır** (hedef ≤900) · `companionChatProvider` **3086** (hedef ≤1200) ·
     ...
     hedefi çok-sistemli rewrite'tır (`docs/archive/AI.md` ihlali), bayrak indirimi ise cihazda
...
- **MAVI-F6 · BİLEŞİK KOMUT + KANONİK ORKESTRASYON — MAVİ TEK CÜMLEDEKİ
  ...
  **Sonraki atomik PR:** F7 (bu turda BİLİNÇLİ olarak başlanmadı). Tam mimari:
  `docs/mavi/CAROS_MAVI_ULTIMATE_OEM_ARCHITECTURE_SPEC_v1.md` §9 · §29.
...
- **MAVI-F3 · STREAMING ASR + SEMANTİK CÜMLE-SONU (2026-08-29, kütük 🔴 #970-#974):**
  ...
  **Sonraki atomik PR:** F4 — streaming LLM + streaming TTS + offline klip sözlüğü.
  Tam mimari: `docs/mavi/CAROS_MAVI_ULTIMATE_OEM_ARCHITECTURE_SPEC_v1.md` §9 · §29.
...
- **MAVI-F1 · YOL ARKADAŞI ARTIK BİR CAPABILITY ŞALTERİ DEĞİL (2026-08-29, kütük 🔴 #963-#965):**
  ...
  **Sonraki atomik PR:** ~~F2 — filler imhası~~ **TAMAMLANDI** (yukarı bkz.) → F3.
  Tam mimari: `docs/mavi/CAROS_MAVI_ULTIMATE_OEM_ARCHITECTURE_SPEC_v1.md` §29.
...
- **MAVI-F0 · UÇTAN UCA GECİKME TELEMETRİSİ (2026-08-29, kütük 🔴 #959-#962):**
  ...
  **Sonraki atomik PR:** F1 — Yol Arkadaşı'nı capability şalteri olmaktan çıkarma
  ...
  `docs/mavi/CAROS_MAVI_ULTIMATE_OEM_ARCHITECTURE_SPEC_v1.md` §29.
...
- **ENVANTER/BAĞLANTI DENETİMİ ve İLK DÖRT DÜZELTME (2026-08-13):** tam suite
  **11 951 test / 526 dosya YEŞİL**, `tsc` temiz, **19 yeni kilit**.
  ...
  Denetim raporu: `docs/archive/ENVANTER_BAGLANTI_DENETIMI_2026-08-12.md`.
...
- **NAV-V3-F8 · Navigasyon v3 — saha ölçüm hazırlığı / enstrümantasyon / replay kanıt paketi (2026-09-04):**
  ...
  `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md` → **§F8**.
...
- **NAV-V3-F7 · Navigasyon v3 — L4 rota: "neden bu rota?" hesap verebilirliği (2026-09-04):**
  ...
  **ÜRÜN HAZIR: HAYIR**. Kütük: 🔴 **#1269** (gerekçe kayıtlı) · 🔴 **#1270**
  ...
  Belge: `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md` → **§F7**.
  ...
  **ÖNCE BİR DÜZELTME (kanıtla):** v3 belgesinde **F7 diye tanımlanmış bir faz
  ...
  `docs/archive/NAVIGATION_ARCHITECTURE_SPEC_v2.md` §12'dedir ve farklı numaralandırır
...
- **NAV-V3-F6 · Navigasyon v3 — sınırlı topoloji koridoru + kenar-tabanlı denetim noktası (2026-09-04):**
  ...
  CPU/bellek). Belge: `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md` → **§F6**.
...
- **NAV-V3-F5 · Navigasyon v3 — CEH tüketici göçü / gölge otorite / cutover kapısı (2026-09-03):**
  ...
  **ÜRÜN HAZIR: HAYIR**. Kütük: 🔴 **#1244** (gölge canlı akışta) · 🔴 **#1245**
  ...
  Belge: `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md` → F5 bölümü.
...
- **NAV-V3-F4 · Navigasyon v3 — L1/L2 topoloji aktivasyonu (RTG2 okuyucu + canlı yol eşleşmesi) (2026-09-03):**
  ...
  Belge: `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md` → F4 bölümü.
...
- **NAV-V3-F3 · Navigasyon v3 — L3 CEH / Electronic Horizon + canlı ego (2026-09-03):**
  ...
  Belge: `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md` → F3 bölümü.
...
- **NAV-V3-F2 · Navigasyon v3 — L2 Ego/Localization (EKF + HMM) (2026-09-03):**
  ...
  **ÜRÜN HAZIR: HAYIR**. Kütük: 🔴 **#1212** (monotonik zaman) · 🔴 **#1213**
  ...
  Belge: `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md` → F2 bölümü.
...
- **NAV-V3-F1 · Navigasyon v3 — L1 MapStore / Map Truth Authority (2026-09-03):**
  ...
  Belge: `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md` → F1 bölümü.
...
- **NAV-V3-F0 · Navigasyon v3 — Mimari Kilit + Çekirdek Sözleşmeler (2026-09-03):**
  ...
  Bağlayıcı hedef mimari: `docs/navigation/NAVIGATION_ARCHITECTURE_SPEC_v3.md`
...
- **NAV-MINIMAP-CONT-P0 · Navigasyon Oturum Sürekliliği (2026-08-03 → 04):**
  ...
  Tam rapor: `docs/archive/NAVIGATION_MINI_MAP_SESSION_CONTINUITY_P0_REPORT.md`.
...
- **FIELD-GAP-CLOSURE-2026-08-05 · Konya→Tarsus saha eksiklerinin ilk kapatma turu:**
  ...
  **ÜRÜN HAZIR: HAYIR**. Kaynak eksik listesi: `docs/archive/NAV_FIELD_GAPS_2026-08-05.md`.
...
- **NAVIGATION-CAMERA-SHADOW · Kamera Politikası Gölge Doğrulaması (2026-08-05):**
  ...
  Tam rapor: `docs/archive/NAVIGATION_CAMERA_SHADOW_REPORT.md`.
...
- **NAVIGATION-MOTION-CAMERA-P0 · Mini Harita Hareketi & Takip Kamerası (2026-08-05):**
  ...
  `realVehicleValidationVerdict = PENDING_REAL_VEHICLE`.
  Tam rapor: `docs/archive/NAVIGATION_MOTION_CAMERA_P0_REPORT.md`.
...
- **NAVIGATION-DELIVERY-CORE-P0 · Teslim Çekirdeği: Ses · Ölü Hesaplama · ETA (2026-08-04):**
  ...
  `realVehicleValidationVerdict = PENDING_REAL_VEHICLE`.
  Kaynak analiz: `docs/archive/NAVIGATION_P0_CORE_OEM_GAP_ANALYSIS.md` (G1·G2·G3).
  Tam rapor: `docs/archive/NAVIGATION_DELIVERY_CORE_P0_REPORT.md`.
...
- **VEHICLE-AWARE-SPEED-LIMIT-P0 · Araç Farkında Hız Sınırı (2026-08-04):**
  ...
  Tam rapor: `docs/archive/VEHICLE_AWARE_SPEED_LIMIT_P0_REPORT.md`.
...
- **NAV-CORE-P0 · Navigasyon Çekirdeği Güvenilirliği (2026-08-03):**
  ...
  Kütük **#364–#372**.
  Durum: **ENTEGRE** (saha kanıtı YOK — ÜRÜN HAZIR: HAYIR).
  Tam rapor: `docs/archive/NAVIGATION_CORE_RELIABILITY_P0_REPORT.md`.
...
- **PRE-ROAD-GATE · Yol Öncesi Güvenlik Kapısı (2026-08-02):**
  ...
  Durum: **ENTEGRE** (saha kanıtı YOK — ÜRÜN HAZIR: HAYIR).
  Tam rapor: `docs/archive/AUTONOMOUS_FIELD_VALIDATION_PRE_ROAD_SAFETY_GATE_REPORT.md`.
...
- **LONGROAD-P0 · Otomatik Uzun Yol Saha Doğrulama (2026-08-02):**
  ...
  Durum: **ENTEGRE** (saha kanıtı YOK — ÜRÜN HAZIR: HAYIR).
  Tam rapor: `docs/archive/AUTONOMOUS_LONG_ROAD_FIELD_VALIDATION_P0_REPORT.md`.
...
- **OBD Diagnostic OS FAZ 0–4:** 25/26 görev kod olarak tamam (+1 gereksiz→kapatıldı),
  ...
  Yalnız 3 madde saha kanıtına ulaştı (§6.1/§6.2). Detay: `docs/archive/OBD_DIAGNOSTIC_OS_ROADMAP.md`.
...
- **CAROS LAB Faz A1 (geliştirici platformu shell'i):** FAZ A / Developer First
  politikasının ilk somut ürünü (`docs/archive/CAROS_LAB_DEVELOPER_PLATFORM_STRATEGY.md`).
...
- **Runtime Scheduling native kanıt körlüğü giderildi:** aynı kopya, LAB'daki poll kanıtı
  ...
  **Dürüstçe beyan edilen sınır:** kapı kapalıyken bile LAB/DebugPanel chunk'ları
  ...
  `docs/operations/RELEASE_CHECKLIST.md`. 24 yeni kilit. **Cihazda doğrulanmadı** (kütük #117).
...
**`docs/archive/TAMAMLAMA_PLANI_2026-08-09.md`**.
...
**🔎 BOŞ YUVA KARARI ÖLÇÜMLE DOĞRULANDI (2026-08-13 — `docs/adr/ADR_RADAR_DATA_SOURCE.md`):**
...
(`docs/archive/RADAR_VERI_TEKLIF_TALEBI_TASLAKLARI.md`), **ilk ticari head unit siparişi
...
> ölçülmüş açıklara (kütük #401–#407 · `docs/archive/NAV_FIELD_GAPS_2026-08-05.md` G1–G19)
...
tamamen düşüyor. Ön-ADR: `docs/adr/ADR_OFFLINE_ROUTING.md` (motor seçimi · veri paketi
...
`docs/adr/ADR_RADAR_DATA_SOURCE.md`): ücretsiz tek aday OSM'de TR genelinde **730**
...
Bu bölümün kod tarafındaki ilerlemesi ve sıradaki üç iş **`docs/archive/HANDOFF_2026-08-11_NAV_OBD.md`**
...
> Görev kırılımı: `docs/archive/OBD_DIAGNOSTIC_OS_ROADMAP.md` (FAZ 0–4).
...
| Ç-1 | `docs/archive/OBD_DIAGNOSTIC_OS_ROADMAP.md` kendini **"TEK GERÇEK KAYNAKTIR"** ilan ediyor; bu belge de ana kaynak olarak konumlanıyor. | İki dosyanın başlıkları. | **Çözüldü:** roadmap **OBD alt-roadmap'idir** (görev kırılımı); vizyon/durum özeti bu belgededir. Roadmap'in kendi ifadesi OBD kapsamıyla sınırlı okunur. |
...
| Ç-4 | `docs/archive/CAROS_15_YIL_VIZYON_YOL_HARITASI.md` (2026-07-08) ve `docs/archive/ROADMAP.md` (2026-06-24) farklı durum tabloları taşıyor. | Tarihler + içerik. | **Tarihsel** ilan edildi (§1). Güncellenmiyorlar; çelişkide bu belge kazanır. |
| Ç-5 | Web sitesi "200+ DTC" diyor; üründe **37** DTC var. | `docs/archive/WEB_URUN_UYUM_BACKLOG.md`. | Açık — P3-5. Pazarlama iddiası **ürün gerçeğine** çekilecek. |
...
Vizyon kapatma planının V-04 maddesi (`docs/archive/VIZYON_KAPATMA_PLANI_2026-08-21.md`)
...
`docs/archive/HANDOFF_2026-09-06_NAV_CARTOGRAPHY.md` §7, ticari navigasyon görsel
