...
- **Runtime Scheduling native kanıt körlüğü giderildi:** aynı kopya, LAB'daki poll kanıtı
  ...
  **Cihazda doğrulanmadı** (kütük #118). Durum: **ENTEGRE**.
  ...
  | Derin Tarama (`deep-scan`) · UDS Gezgini · Araç Çağrısı · Kıyaslama | Ekran PLACEHOLDER | **Bellek/Bilgi Gezgini bu listeden ÇIKTI** — 2026-08-21'de açıldı (kütük #692). Kalan dördü: `deep-scan` motoru var ama tek güvenli giriş noktası yok (iki ayrı akış); `uds-explorer` istek ÜRETEN bir gezgin olduğu için güvenlik incelemesi bekliyor; `tool-calling` ve `benchmark` motoru gerçekten olmayan **dürüst placeholder** — bu ikisi gözlemlenebilirlik borcu DEĞİLDİR. |
  ...
  Katalog kapsamı bugün: **53 AVAILABLE · 4 PLACEHOLDER · 2 DISABLED** (59 araç)
  ...
  (`AVAILABLE` diyip ekranı olmayan tek araç bile yok — host kilidi mevcut; 2026-08-21 son ölçüm **53/53**).
