# Migration 021 + 022'yi Supabase Management API query endpoint'i ile uygular
# (SQL Editor eşdeğeri). Token Windows Credential Manager'dan okunur, yazdırılmaz.
...
try {
    # CREDENTIAL struct (x64): CredentialBlobSize offset 32 (DWORD), CredentialBlob offset 40 (ptr)
...
$files = @(
    'supabase\migrations\20260610000021_vehicle_events_superadmin_read.sql',
    'supabase\migrations\20260610000022_voice_diag_log_type.sql'
)
...
Write-Output "=== Iki migration da uygulandi ==="
