...
const N_ML = 200;                 // HAVUZUN TAMAMI istenir (Region1 full-pool sweep, #1321)
const N_OSM = 50;                 // HAVUZUN TAMAMI istenir
...
writeFileSync(HERE + 'sheet-full.html', html, 'utf8');

/* ── 4) Kanıt dosyaları ──────────────────────────────────────────────────── */
writeFileSync(HERE + 'mosaic-provenance-full.json', JSON.stringify({
...
writeFileSync(HERE + 'sample-key-full.json', JSON.stringify({
