...
export const CAROS_LAB_TOOLS: readonly CarosLabTool[] = Object.freeze([
  ...
  },
  {
    ...
    desc: 'L1 MapStore’un ALTINDAKİ veri üretim/normalizasyon katmanının salt-okunur gözlemi: tanımlı kaynak sözlüğü (OSM · OpenFreeMap · Overture · TUCBS · belediye · lisanslı sağlayıcı · saha gözlemi · türetilmiş) · her kaynağın lisans politikası ve DÖRT kullanım niyeti için GERÇEKTEN çalıştırılmış kapı hükmü (ölçüm · çevrimiçi · offline paketleme · türev dağıtım) · share-alike ve atıf yükümlülüğü · tanınan SPDX etiketleri · kaynak başına tazelik bütçesi · fusion ağırlıkları (tazelik/mutabakat/kalite/yetki önseli) ve bina eşleştirme politikası (merkez mesafesi · alan oranı · içerme şartı) · adres/yer/canlı-koşul portlarına sağlayıcı BAĞLI MI ve bağlı değilse ÖLÇÜLMÜŞ gerekçesi · canlı yol koşulu tazelik bütçeleri.',
    status: 'AVAILABLE', layer: 'mapdata (saf sözleşme katmanı)',
    note: 'Hiçbir şey BAŞLATMAZ: sağlayıcı bağlama/çözme, veri kümesi indirme, ağ çağrısı, lisans kabulü, fusion çalıştırma, timer/polling/abonelik YOK — yalnız senkron kod sabitleri okunur. ÇALIŞMA ZAMANI HARİTA GERÇEĞİ BURADA DEĞİLDİR: karo/graf/POI durumu NAV v3 L1 MapStore’un sahipliğindedir ve Navigation Core ekranında gözlenir; burada İKİNCİ bir harita gerçeği yüzeyi kurulmaz. İKİNCİ OTORİTE DEĞİL: hak, eşik ve politika değerleri kanonik modüllerden (mapDataLicense · mapDataResolution · buildingResolver) AYNEN okunur; ekranda hesaplanan hiçbir değer üretim kararına geri beslenmez. BUGÜNKÜ DURUM: adres, yer ve canlı-koşul portlarının ÜÇÜ DE BAĞLI DEĞİLDİR — bu bir arıza değil, sözleşme fazının doğru hâlidir ve ekran bunu böyle söyler; "bağlı sağlayıcı" olması da veri KAPSAMI olduğu anlamına gelmez. Lisans kapısı sabit metin değildir, her açılışta evaluateLicenseGate ile GERÇEKTEN çalıştırılır ve UNKNOWN hak fail-closed RED üretir. GİZLİLİK: koordinat, adres, sorgu metni ve kullanıcı verisi bu ekrana GELMEZ. Ölçüm kaynağı: field-runs/map-data-coverage-20260907 ve field-runs/mapdata-shootout-20260907. Gerçek araç doğrulaması bu ekran için GEREKMEZ (çalışma zamanına bağlı değildir); üretim davranışını değiştiren tek MAPDATA maddesi kapı numarası katmanıdır (kütük #1318).',
  },
  {
