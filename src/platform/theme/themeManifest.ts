/**
 * Tema Manifesti v2 — CarOS Pro görsel dilinin TEK kanonik sözleşmesi (araç tarafı).
 *
 * PWA kopyası: website/src/lib/theme/themeManifest.ts — ilk yorum bloğu dışında
 * BİREBİR aynıdır (themeManifestParity testi kilitler).
 * ---8<--- PARITY-START --->8---
 *
