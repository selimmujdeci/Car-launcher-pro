...
const NIGHT_H: Pal = {
  ...
  accent: 'var(--accent-primary, #F2871C)', accent2: 'var(--accent-secondary, #FFB35C)', accentDeep: '#B25F0C', accentGlow: 'rgba(var(--accent-rgb, 242,135,28), .42)', accentInk: 'var(--oem-accent-ink, #1A0D02)',
...
const DAY_H: Pal = {
  ...
  accent: 'var(--accent-primary, #DA801A)', accent2: 'var(--accent-secondary, #E89A3C)', accentDeep: '#A85C0C', accentGlow: 'rgba(var(--accent-rgb, 218,128,26), .28)', accentInk: 'var(--oem-accent-ink, #FFF6E9)',
