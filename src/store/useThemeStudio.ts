...
const PRESETS: Record<CoreTheme | LegacyTheme, Omit<ThemeToken, 'name'>> = {
  ...
  expedition: {
    baseTheme: 'expedition',
    accentPrimary:   '#E07B14',
    accentSecondary: '#F2871C',
    bgPrimary:       '#14110C',
    bgCard:          'rgba(28,22,16,0.95)',
    textPrimary:     '#EDE4D2',
    textSecondary:   '#AE9C7E',
    borderColor:     'rgba(176,134,76,0.25)',
    glowColor:       'rgba(242,135,28,0.20)',
    radiusCard:  20, radiusBtn:  12, radiusTile:  12, radiusDock:  20,
    cardBlurPx:     0, glowIntensity: 40,
    fontFamily: 'system', fontWeight: 700, letterSpacing: 1,
    iconNav:   '#E07B14', iconMedia: '#F2871C', iconDock: '#E07B14',
  },
  horizon: {
    baseTheme: 'horizon',
    accentPrimary:   '#F2871C',
    accentSecondary: '#E07B14',
    bgPrimary:       '#0D0F13',
    bgCard:          'rgba(24,26,32,0.96)',
    textPrimary:     '#F2F4F7',
    textSecondary:   '#9AA2AD',
    borderColor:     'rgba(255,255,255,0.08)',
    glowColor:       'rgba(242,135,28,0.32)',
    radiusCard:  18, radiusBtn:  12, radiusTile:  14, radiusDock:  18,
    cardBlurPx:     0, glowIntensity: 45,
    fontFamily: 'system', fontWeight: 600, letterSpacing: 0,
    iconNav:   '#F2871C', iconMedia: '#F2871C', iconDock: '#9AA2AD',
  },
  sunlight: {
    baseTheme: 'sunlight',
