    ...
    <header className="h-16 flex-shrink-0 flex items-center justify-between px-6 border-b border-white/[0.06] bg-[#070e1c]/80 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/[0.08] border border-emerald-500/20">
          ...
          <span className="text-[11px] text-emerald-400 font-medium">{onlineCount} araç aktif</span>
        </div>
        ...
        {/* Avatar */}
        <div className="w-9 h-9 rounded-xl bg-accent/20 border border-accent/30 flex items-center justify-center text-xs font-semibold text-accent cursor-pointer hover:bg-accent/25 transition-colors">
          A
        </div>
      </div>
    </header>
