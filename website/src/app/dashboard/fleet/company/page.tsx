...
/**
 * /dashboard/fleet/company — FİLO YÖNETİMİ (şirket · üye · araç kapsamı).
 *
 * #662'de `/dashboard/fleet` Kanıt Konsolu genel bakışına devredildi; bu ekran
 * içeriği DEĞİŞMEDEN yönetim sekmesine taşındı (davranış aynı, yalnız yer).
 *
      ...
      {!fleet.company ? (
        ...
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <FleetLink href="/dashboard/fleet/company-vehicles"  title="Araçlar"  value={`${fleet.vehicles.length}`} />
